        ...
        <div className="grid grid-cols-1 sm:grid-cols-2">
          ...
          <div className="order-2 sm:order-1 ">
            ...
            <div>
                <button className="bg-gradient-to-r from-primary to-secondary border-2
                 border-primary rounded-full px-4 py-4 text-white hover:scale-105 duration-200">
                    Coffee and Code
                </button>
            </div>
          </div>
          ...
          <div className="min-h-[450px] flex justify-center items-center order-1 sm:order-2 relative">
            ...
            <div className="bg-gradient-to-r from-primary to-secondary absolute top-10 left-10 p-3 rounded-xl">
                <h1>Hey Coder</h1>
            </div> <div className="bg-gradient-to-r from-primary to-secondary absolute bottom-10 right-10 p-3 rounded-xl">
                <h1>Best Coffee</h1>
            </div>
          </div>
        </div>
